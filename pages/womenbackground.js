...
const Womenbackground = () => {
  ...
  let array = [
    ...
    {
      image: "/Women/homewomensec1/bg2.avif",
    ...
    {
      image: "/Women/homewomensec1/bg1.avif",
    ...
    {
      image: "/Women/homewomensec1/bg4.avif",
    ...
    {
      image: "/Women/homewomensec1/bg3.avif",
    ...
    <>
      <div className="container-fluid g-0 mt-5">
        <div className="container g-0">
          <h3 className="Homewomen1h3">Women"s Store</h3>
