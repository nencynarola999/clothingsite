        ...
        <>
            <Dropdown autoClose="outside " >
                <div className={sticky ? nav2link2 : nav2link1}>
                    <Link href="" variant="auto" className="  w-100 d-flex justify-content-evenly align-items-center" onClick={handleShow} >
                        Kids <span className="ms-auto fs-2"><MdOutlineKeyboardArrowRight /></span>
                    </Link>
                </div>
...
export default KidsMobile2black