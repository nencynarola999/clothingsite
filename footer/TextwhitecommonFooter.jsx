...
const TextwhitecommonFooter = () => {
    return (
        <>
            <div className="whitecommonfootermaindiv" >
                <div className="container ">
                    <div className="row gy-5  gy-lg-0">
                        <div className="col-md-4 col-xl-3">
                            <div>
                                <img className="mb-4 mt-3" src="/navbar/logo/logo-light.png" alt="" />
                                <p className="mb-4">
...
export default TextwhitecommonFooter